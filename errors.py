# -*- coding: utf-8 -*-
"""
Created on Mon May 20 11:00:20 2019
...
os.environ['CENSUS_KEY'] = "daa1343c8d20e382aa287d308a80674f42fc1f92"


class census(object):
    def __init__(self, estimates, year = 2017, dataset = 1, geography = "state", geoids = "*", statefips = None, countyfips = None, key = os.getenv('CENSUS_KEY')):
